        ...
        <StyledContainer style={props}>
            ...
            <StyledFrameContainerDiv>
                <StyledOverlayDiv onClick={() => CraftApiWrapper.openUrl(
                    Defines.CRAFTCUTS_DOWNLOAD_LINK,
                )}
                >
                    {
                ...
                <StyledFrame frameBorder="0" onLoad={() => setIframeLoaded(true)} src={Defines.CRAFTCUTS_UPDATE_STATUS_LINK} />
            </StyledFrameContainerDiv>
            <StyledHeader>
                Hi There ✌️
            </StyledHeader>
            <StyledTextDiv>
                ...
                .
                {' '}
                the developer of Craftcuts. Thank you for downloading and using this eXtension.
            </StyledTextDiv>
            <StyledHeader>
                Help 🆘, Bugs 🐛 & Feedback 📫
            </StyledHeader>
            <StyledTextDiv>
                You can find the documentation, videos and many compatible Shortcuts in the
                {' '}
            ...
            <StyledTextDiv>
                Craftcuts is entirely free to use for you.
            </StyledTextDiv>
            <StyledTextDiv>
